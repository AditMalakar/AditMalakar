...
import 'package:vidflix/widgets/final_screen/component_21.g.dart';
    ...
    return Material(
      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          height: 121.83,
          child: Container(
              height: 121.83023071289062,
              width: 151.00000762939453,
                ...
                Positioned(
                  ...
                  child: Container(
                      ...
                      child: Stack(children: [
                        ...
                        Positioned(
                          left: MediaQuery.of(context).size.width * 0.113,
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.027604971613202776,
                            width: MediaQuery.of(context).size.width *
                                0.035205638351071857,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Positioned(
                        ...
                        Positioned(
                          left: MediaQuery.of(context).size.width * 0.244,
                          width: 0,
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.000016008104596819195,
                            width: MediaQuery.of(context).size.width *
                                0.000384842140087183,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Positioned(
                          left: MediaQuery.of(context).size.width * 0.254,
                          width: 0,
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.00015722002301897322,
                            width: MediaQuery.of(context).size.width *
                                0.00016820833878816613,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Positioned(
                        ...
                        Positioned(
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.0062842028481619695,
                            width: MediaQuery.of(context).size.width *
                                0.008917333999117791,
                            fit: BoxFit.fill,
                          ),
                        ),
                      ])),

      ...
      child: Stack(children: [
                      ...
                      child: Stack(children: [
                        ...
                        Positioned(
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.010876110621861048,
                            width: MediaQuery.of(context).size.width *
                                0.013870607827596618,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Positioned(
                        ...
                        Positioned(
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.024600846426827565,
                            width: MediaQuery.of(context).size.width *
                                0.023639771097524156,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Positioned(
                        ...
                        Positioned(
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.000006335122244698661,
                            width: MediaQuery.of(context).size.width *
                                0.0001515558952294686,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Positioned(
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.00006232942853655134,
                            width: MediaQuery.of(context).size.width *
                                0.00006663741696859903,
                            fit: BoxFit.fill,
                          ),
                        ),
                        Positioned(
                        ...
                        Positioned(
                          ...
                          child: SvgPicture.asset(
                            ...
                            package: 'vidflix',
                            height: MediaQuery.of(context).size.height *
                                0.002475942884172712,
                            width: MediaQuery.of(context).size.width *
                                0.0035135020380434785,
                            fit: BoxFit.fill,
                          ),
                        ),
                      ])),
        ...
        Positioned(
          ...
          child: Container(
              ...
              width: 299.0,
              child: AutoSizeText(
                'Unlimited films, programmes & more',
                style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 30,
